...
/*     Vai ser impresso todos o objeto usuarios.
 */
/* 2. Leia o código abaixo
    ...
    /* Vai ser impresso os nomes do objeto usuarios */
...
/* 3. Leia o código abaixo
    ...
    Vai ser impresso somente as propriedades de Amanda e Laís
 ...
 */
  ...
  /*   1. Dado o seguinte array de cachorrinhos que são clientes de um pet shop, realize as operações pedidas nos itens abaixo utilizando as funções de array **map** e **filter:**
    ...
    const doguinhos = pets.map((item,index,array) => {
        return item.nome;
    ...
    const doguinhoSalsicha = pets.filter((item,index,array)=>{
    ...
    console.log(poodles);
    const MensagemParaPoodle = poodles.map((item,index,array)=>{
 ...
 */    
        const nomePreçoItens = produtos.map((produtos) =>{
            const desconto = 0.95;
            return { nome: produtos.nome, preço: produtos.preco*desconto.toFixed(0)};

        })

        console.log(nomePreçoItens);
 ...
 */    
        ...
        const BedidasItem = produtos.filter((produtos) => {
            return produtos.categoria === "Bebidas"
        })

        console.log(BedidasItem);
/*     d) Crie um novo array que contenha apenas os objetos cujo nome contenha a palavra "Ypê"
 */    

        const nomeYpe = produtos.filter((produtos) => {
 ...
 */     
        ...
        const frases = nomeYpe.map((nomeYpe) => {
